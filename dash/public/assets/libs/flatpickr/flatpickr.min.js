!(function (e, n) {
    ...
    function E(p, v) {
                ...
                (function (e) {
                    ...
                    if (void 0 !== a.value && 2 === a.value.length) {
                        ...
                        d < i
                            ...
                            : d > l &&
                              ((d =
                                  a === w.hourElement ? d - l - r(!w.amPM) : i),
                              f && H(void 0, 1, w.hourElement)),
                            w.amPM &&
                                u &&
                                (1 === c
        ...
        function O(e) {
            ...
            n &&
                n instanceof Date &&
                F(n.getHours(), n.getMinutes(), n.getSeconds());
        }
        function F(e, n, t) {
        ...
        function J(e, n) {
            for (
                ...
                o.appendChild(
                    L("flatpickr-day " + l, new Date(e, n - 1, s), 0, u)
                );
            for (s = 1; s <= i; s++, u++)
            ...
            for (
                ...
                o.appendChild(
                    L("flatpickr-day " + c, new Date(e, n + 1, f % i), 0, u)
                );
        ...
        function Me(e) {
            void 0 === e && (e = !0),
                ...
                void 0 !== w.altInput &&
                    (w.altInput.value = Ce(w.config.altFormat)),
                        ...
                        e && ge(e, w.config.dateFormat),
                            (w._initialDate =
                                w.selectedDates.length > 0
                                    ? w.selectedDates[0]
                                    : w.config.minDate &&
                                      w.config.minDate.getTime() >
                                          w.now.getTime()
                                    ? w.config.minDate
                                    : w.config.maxDate &&
                                      w.config.maxDate.getTime() <
                                          w.now.getTime()
                                    ? w.config.maxDate
                                    : w.now),
                            (w.currentYear = w._initialDate.getFullYear()),
