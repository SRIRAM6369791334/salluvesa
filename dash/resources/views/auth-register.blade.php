                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free Saaluvesa account now.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="index">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center text-muted p-4">
                            <p class="text-white-50">©
                                ...
                                </script> Saaluvesa. Crafted with <i class="mdi mdi-heart text-danger"></i>
