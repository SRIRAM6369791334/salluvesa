          ...
          <div class="cs_filter_sidebar">
            ...
            <div class="cs_filter_sidebar_in">
              <div class="cs_filter_widget">
                <h3 class="cs_filter_widget_title cs_medium cs_fs_18">{{ gt('Categories') }} <span></span></h3>
                <ul class="cs_filter_category cs_mp0">
                  @foreach($categories as $category)
                  <li>
                    <div class="premium-checkbox-group">
                      <input type="checkbox" class="premium-control-input" name="category_id" value="{{ $category->id }}" {{ request('category_id') == $category->id ? 'checked' : '' }}>
                      <label class="m-0" style="cursor: pointer;">{{ $category->category_name }} ({{ $category->subCategories->count() }})</label>
                    </div>
                    ...
                    <ul>
                      ...
                      <li>
                        <div class="premium-checkbox-group">
                          <input type="checkbox" class="premium-control-input" name="subcategory_id" value="{{ $sub->id }}">
                          <label class="m-0" style="cursor: pointer;">{{ $sub->subcategory_name }}</label>
                        </div>
                      </li>
                      @endforeach
                    </ul>
              ...
              <div class="cs_filter_widget">
                <h3 class="cs_filter_widget_title cs_medium cs_fs_18">{{ gt('Price') }} <span></span></h3>
              ...
              <div class="cs_filter_widget">
                <h3 class="cs_filter_widget_title cs_medium cs_fs_18">{{ gt('Color') }} <span></span></h3>
                <ul class="cs_color_filter_list cs_mp0">
                  <li>
                    <label class="premium-checkbox-group">
                      <input type="radio" name="color" class="premium-control-input">
              ...
              <div class="cs_filter_widget">
                <h3 class="cs_filter_widget_title cs_medium cs_fs_18">{{ gt('Size') }} <span></span></h3>
                <ul class="cs_size_filter_list cs_mp0">
                  <li>
                    <label class="premium-checkbox-group">
                      <input type="radio" name="size" class="premium-control-input">
                      <span>S</span>
                    </label>
                  </li>
                  <li>
              ...
              <div class="cs_filter_widget">
                <h3 class="cs_filter_widget_title cs_medium cs_fs_18">{{ gt('Garment') }} <span></span></h3>
                <ul class="cs_brand_filter_list cs_mp0">
                  <li>
                    <label class="premium-checkbox-group">
                      <input type="radio" name="brand" class="premium-control-input">
                      <span>{{ gt('T- SHIRTS') }}</span>
                    </label>
                  </li>
                  <li>
                    <label class="premium-checkbox-group">
                      <input type="radio" name="brand" class="premium-control-input">
                      <span>{{ gt('SHIRTS (FORMAL)') }}</span>
                    </label>
                  </li>
                  <li>
                    <label class="premium-checkbox-group">
                      <input type="radio" name="brand" class="premium-control-input">
                      <span>{{ gt('TANK TOPS (WOMEN)') }}</span>
                    </label>
                  </li>
                  <li>
                    <label class="premium-checkbox-group">
                      <input type="radio" name="brand" class="premium-control-input">
                      <span>{{ gt('POLO T – SHIRTS (MEN)') }}</span>
                    </label>
                  </li>
                  <!-- <li>
        ...
        <div class="col-lg-9">
          <div class="cs_sort_section">
            <div class="cs_sort_number">
              <p class="cs_medium mb-0">{{ gt('Showing') }} {{ $products->firstItem() ?? 0 }}–{{ $products->lastItem() ?? 0 }} {{ gt('of') }} {{ $products->total() }} {{ gt('results') }}</p>
            </div>
            <div class="cs_sort_wrap">
              <div class="cs_sort">
                <select class="premium-form-input premium-form-select" style="height: 45px; min-width: 200px;">
                  <option selected>{{ gt('Sort By Latest') }}</option>
                  <option value="1">{{ gt('Sort By Low Price') }}</option>
                  <option value="2">{{ gt('Sort By High Price') }}</option>
                </select>
              </div>
              <div class="cs_view">
            ...
            <div class="cs_product_col">
              <div class="cs_product cs_style_1">
                <div class="cs_product_thumb position-relative">
                  <img src="{{ asset($product->product_image) }}" alt="{{ $product->product_name }}" class="w-100">
                  <div class="cs_cart_badge position-absolute">
                    <a href="wishlist" class="cs_cart_icon cs_accent_bg cs_white_color">
                      <i class="fa-regular fa-heart"></i>
                    </a>
                    <a href="{{ route('product.details', $product->id) }}" class="cs_cart_icon cs_accent_bg cs_white_color">
                ...
                <div class="cs_product_info text-center">
                  ...
                  <p class="cs_product_price cs_fs_18 cs_accent_color mb-0 cs_medium">{{ format_currency($product->product_mrp_price) }}</p>
                  <p class="cs_product_desc mt-2">{{ Str::limit($product->product_description, 80) }}</p>
                </div>
              </div>
            </div>
            @empty
            <div class="col-12 py-5 text-center">
              <p>{{ gt('No products found matching your criteria.') }}</p>
            </div>
            @endforelse
