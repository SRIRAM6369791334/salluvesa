  ...
  */
  ...
  function priceInit() {
    if ($.exists('#slider_range')) {
      ...
      $('#slider_range').slider({
        ...
        min: 0,
        max: 1000 * rate,
        values: [100 * rate, 600 * rate],
        slide: function (event, ui) {
          $('#amount').val(
            'Price: ' + symbol + ui.values[0].toFixed(2) + ' - ' + symbol + ui.values[1].toFixed(2),
          );
        },
      });
    }
    if ($.exists('#amount')) {
      ...
      $('#amount').val(
        'Price: ' + symbol +
        $('#slider_range').slider('values', 0).toFixed(2) +
        ' - ' + symbol +
        $('#slider_range').slider('values', 1).toFixed(2),
      );
    }
  }
  /*----------------------------------------------------------
  ...
  function shopGeneral() {
    ...
    $('.cs_increment').click(function () {
      ...
      var count = parseInt(countElement.val()) || 0;
      count++;
      countElement.val(count).trigger('change');
    });
